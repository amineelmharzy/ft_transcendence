...
class Sidebar extends HTMLElement {
    ...
    create() {
        this.sidebar.className = "sidebar d-flex flex-column text-white"
        this.sidebar.innerHTML = `
            <div>
                <a href="https://1337.ma/" class="navbar-brand align-items-center text-decoration-none pt-3 ms-3">
                    <span class="fs-4">1337</span>
                </a>
                <div class="mt-5 mb-auto">
                    <ul class="nav flex-column mb-auto">
                        ...
                        <li class="nav-item">
                            <a href="/latest" class="nav-link d-flex">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <li class="nav-item">
                            <a href="/play" class="nav-link d-flex">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <li class="nav-item">
                            <a href="/chat" class="nav-link d-flex">
                        ...
                        <li class="nav-item">
                            <a href="/explore" class="nav-link d-flex">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <li class="nav-item">
                            <a href="/events" class="nav-link d-flex">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
